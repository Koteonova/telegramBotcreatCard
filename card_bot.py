...
bot = TeleBot(token='5725250545:AAEOoCxa4H-2VNXMLTgP1-SxMaSVMipAs7s', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(message.chat.id, "Привет, {0.first_name}!Я умею генерировать номер тестовой банковской карты\nВыбери тип карты:".format(message.from_user, bot.get_me()),
        parse_mode='html', reply_markup=card_type_keybaord)
 #   bot.send_message(
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message(
            ...
            text='Не понимаю тебя😢 Может попробуешь еще разок',
        )
        return
